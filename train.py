...
def get_args():
    ...
    parser.add_argument("--log_path","-l",type=str,default ="tensorboard/vegetables")
    parser.add_argument("--checkpoint_path","-c",type=str,default="trained_models/vegetables")
...
def train(args):
    ...
    for epoch in range(start_epoch,args.num_epochs):
        ...
        for iter,(images,labels) in enumerate(progress_bar):
            ...
            progress_bar.set_description("Epoch: {}/{}. Train Loss: {}".format(epoch+1,args.num_epochs,round(average_loss,2)))
